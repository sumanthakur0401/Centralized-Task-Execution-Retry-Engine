...
* The original package name 'io.reliasync.platform.reliable-async-platform' is invalid and this project uses 'io.reliasync.platform.reliable_async_platform' instead.
